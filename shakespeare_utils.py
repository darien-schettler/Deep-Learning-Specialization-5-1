...
def vectorization(X, Y, n_x, char_indices, Tx=40):
    ...
    # Make empty np arrays that mirror the shape of desired inputs and labels
...
text = io.open('Jordan_Peterson_Corpus.txt', encoding='utf-8').read().lower()
